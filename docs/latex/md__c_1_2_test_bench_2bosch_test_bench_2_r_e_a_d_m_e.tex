...
\Hypertarget{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md0}%
 \hypertarget{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md1}{}\doxysection{\texorpdfstring{Table of Contents}{Table of Contents}}\label{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md1}
...
\item Configuration
\item Frequency and Time Period Details
\item How to Use
\item Code Explanation
\item Notes
\item Visual Representation
\item Side Note\+: Setting the Compare Match Register for 1k\+Hz Frequency
\begin{DoxyItemize}
\item Timer and Compare Match Register
\item Setting Up for 1k\+Hz Frequency
\item 2k\+Hz Frequency
\item 5k\+Hz Frequency
\item 0.5\+Hz Frequency
\item What Happens at Runtime
\end{DoxyItemize}
\end{DoxyEnumerate}\hypertarget{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md2}{}\doxysubsection{\texorpdfstring{Overview}{Overview}}\label{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md2}
This Arduino sketch generates a Pulse Width Modulation (PWM) signal using Timer1 interrupts. It allows selecting predefined frequencies for the PWM signal, providing precise control suitable for LED dimming, motor control, and signal generation.\hypertarget{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md3}{}\doxysubsection{\texorpdfstring{Hardware Requirements}{Hardware Requirements}}\label{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md3}
...
\end{DoxyItemize}\hypertarget{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md4}{}\doxysubsection{\texorpdfstring{Software Requirements}{Software Requirements}}\label{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md4}

\begin{DoxyItemize}
\item Arduino IDE for uploading the sketch to the Arduino board
\end{DoxyItemize}\hypertarget{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md5}{}\doxysubsection{\texorpdfstring{Configuration}{Configuration}}\label{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md5}
...
\end{DoxyItemize}\hypertarget{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md6}{}\doxysubsection{\texorpdfstring{Frequency and Time Period Details}{Frequency and Time Period Details}}\label{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md6}
...
These time periods represent the duration of one complete cycle of the PWM signal at each frequency.\hypertarget{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md7}{}\doxysubsection{\texorpdfstring{How to Use}{How to Use}}\label{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md7}
...
\end{DoxyEnumerate}\hypertarget{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md8}{}\doxysubsection{\texorpdfstring{Code Explanation}{Code Explanation}}\label{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md8}
...
\end{DoxyItemize}\hypertarget{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md9}{}\doxysubsection{\texorpdfstring{Notes}{Notes}}\label{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md9}
...
\end{DoxyItemize}\hypertarget{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md10}{}\doxysubsection{\texorpdfstring{Visual Representation}{Visual Representation}}\label{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md10}
For a visual representation and simulation of the circuit used in this project, visit the following Tinkercad link\+: \href{https://www.tinkercad.com/things/abLLm7h7TJJ-funky-juttuli/editel?sharecode=Xo09mCwedb-p-YJO-K1cbwH3dxxOUjxbuBEUPvEbV6E}{\texttt{ Tinkercad Circuit Simulation}}. This simulation provides an interactive way to understand how the components are connected and how the PWM signal affects the circuit.\hypertarget{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md11}{}\doxysubsection{\texorpdfstring{Side Note\+: Setting the Compare Match Register for Several Frequencies}{Side Note\+: Setting the Compare Match Register for Several Frequencies}}\label{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md11}
The line in the code {\ttfamily // Set compare match register to desired timer count for 1k\+Hz frequency} is a crucial part of setting up the Timer1 interrupt in the Arduino. Let\textquotesingle{}s break down this concept for a clearer understanding.\hypertarget{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md12}{}\doxysubsubsection{\texorpdfstring{Timer and Compare Match Register}{Timer and Compare Match Register}}\label{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md12}
...
the line of code that sets the OCR1A register determines the desired frequency for the interrupt. Here\textquotesingle{}s how it works for each frequency\+:\hypertarget{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md13}{}\doxysubsubsection{\texorpdfstring{Setting Up for 1k\+Hz Frequency}{Setting Up for 1k\+Hz Frequency}}\label{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md13}
...
\end{DoxyEnumerate}\hypertarget{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md14}{}\doxysubsubsection{\texorpdfstring{2k\+Hz Frequency}{2k\+Hz Frequency}}\label{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md14}

\begin{DoxyItemize}
\item Prescaler\+: 8
\item Calculation\+: {\ttfamily OCR1A = (2,000,000 / 2,000) -\/ 1 = 999}
\end{DoxyItemize}\hypertarget{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md15}{}\doxysubsubsection{\texorpdfstring{5k\+Hz Frequency}{5k\+Hz Frequency}}\label{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md15}

\begin{DoxyItemize}
\item Prescaler\+: 8
\item Calculation\+: {\ttfamily OCR1A = (2,000,000 / 5,000) -\/ 1 = 399}
\end{DoxyItemize}\hypertarget{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md16}{}\doxysubsubsection{\texorpdfstring{0.\+5\+Hz Frequency}{0.\+5\+Hz Frequency}}\label{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md16}
...
These calculations ensure that the timer generates interrupts at the specified frequencies, creating the desired PWM signals.\hypertarget{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md17}{}\doxysubsubsection{\texorpdfstring{What Happens at Runtime}{What Happens at Runtime}}\label{md__c_1_2_test_bench_2bosch_test_bench_2_r_e_a_d_m_e_autotoc_md17}
