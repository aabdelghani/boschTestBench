...
\end{DoxyItemize}
\end{DoxyEnumerate}\hypertarget{md__r_e_a_d_m_e_autotoc_md2}{}\doxysubsection{Overview}\label{md__r_e_a_d_m_e_autotoc_md2}
This Arduino sketch generates a Pulse Width Modulation (PWM) signal using Timer1 interrupts. It allows selecting predefined frequencies for the PWM signal, providing precise control suitable for LED dimming, motor control, and signal generation.\hypertarget{md__r_e_a_d_m_e_autotoc_md3}{}\doxysubsection{Hardware Requirements}\label{md__r_e_a_d_m_e_autotoc_md3}
...
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_autotoc_md4}{}\doxysubsection{Software Requirements}\label{md__r_e_a_d_m_e_autotoc_md4}

\begin{DoxyItemize}
\item Arduino IDE for uploading the sketch to the Arduino board
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_autotoc_md5}{}\doxysubsection{Configuration}\label{md__r_e_a_d_m_e_autotoc_md5}
...
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_autotoc_md6}{}\doxysubsection{Frequency and Time Period Details}\label{md__r_e_a_d_m_e_autotoc_md6}
...
These time periods represent the duration of one complete cycle of the PWM signal at each frequency.\hypertarget{md__r_e_a_d_m_e_autotoc_md7}{}\doxysubsection{How to Use}\label{md__r_e_a_d_m_e_autotoc_md7}
...
\end{DoxyEnumerate}\hypertarget{md__r_e_a_d_m_e_autotoc_md8}{}\doxysubsection{Code Explanation}\label{md__r_e_a_d_m_e_autotoc_md8}
...
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_autotoc_md9}{}\doxysubsection{Notes}\label{md__r_e_a_d_m_e_autotoc_md9}
...
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_autotoc_md10}{}\doxysubsection{Visual Representation}\label{md__r_e_a_d_m_e_autotoc_md10}
For a visual representation and simulation of the circuit used in this project, visit the following Tinkercad link\+: \href{https://www.tinkercad.com/things/abLLm7h7TJJ-funky-juttuli/editel?sharecode=Xo09mCwedb-p-YJO-K1cbwH3dxxOUjxbuBEUPvEbV6E}{\texttt{ Tinkercad Circuit Simulation}}. This simulation provides an interactive way to understand how the components are connected and how the PWM signal affects the circuit.\hypertarget{md__r_e_a_d_m_e_autotoc_md11}{}\doxysubsection{Side Note\+: Setting the Compare Match Register for Several Frequencies}\label{md__r_e_a_d_m_e_autotoc_md11}
The line in the code {\ttfamily // Set compare match register to desired timer count for 1k\+Hz frequency} is a crucial part of setting up the Timer1 interrupt in the Arduino. Let\textquotesingle{}s break down this concept for a clearer understanding.\hypertarget{md__r_e_a_d_m_e_autotoc_md12}{}\doxysubsubsection{Timer and Compare Match Register}\label{md__r_e_a_d_m_e_autotoc_md12}
...
the line of code that sets the OCR1A register determines the desired frequency for the interrupt. Here\textquotesingle{}s how it works for each frequency\+:\hypertarget{md__r_e_a_d_m_e_autotoc_md13}{}\doxysubsubsection{Setting Up for 1k\+Hz Frequency}\label{md__r_e_a_d_m_e_autotoc_md13}
...
\end{DoxyEnumerate}\hypertarget{md__r_e_a_d_m_e_autotoc_md14}{}\doxysubsubsection{2k\+Hz Frequency}\label{md__r_e_a_d_m_e_autotoc_md14}

\begin{DoxyItemize}
\item Prescaler\+: 8
\item Calculation\+: {\ttfamily OCR1A = (2,000,000 / 2,000) -\/ 1 = 999}
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_autotoc_md15}{}\doxysubsubsection{5k\+Hz Frequency}\label{md__r_e_a_d_m_e_autotoc_md15}

\begin{DoxyItemize}
\item Prescaler\+: 8
\item Calculation\+: {\ttfamily OCR1A = (2,000,000 / 5,000) -\/ 1 = 399}
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_autotoc_md16}{}\doxysubsubsection{0.\+5\+Hz Frequency}\label{md__r_e_a_d_m_e_autotoc_md16}
...
These calculations ensure that the timer generates interrupts at the specified frequencies, creating the desired PWM signals.\hypertarget{md__r_e_a_d_m_e_autotoc_md17}{}\doxysubsubsection{What Happens at Runtime}\label{md__r_e_a_d_m_e_autotoc_md17}
...
In summary, setting the compare match register to the appropriate value based on the timer\textquotesingle{}s clock frequency and desired output frequency is a key step in utilizing timers for precise timing operations in microcontrollers.\hypertarget{md__r_e_a_d_m_e_autotoc_md18}{}\doxysubsection{Documentation}\label{md__r_e_a_d_m_e_autotoc_md18}
The complete Doxygen-\/generated documentation for this project can be found at \href{https://aabdelghani.github.io/boschTestBench/}{\texttt{ Bosch\+Test\+Bench Documentation}}. This documentation provides detailed insights into the structure and functionality of the code, making it easier for developers to understand and contribute to the project.\hypertarget{md__r_e_a_d_m_e_autotoc_md19}{}\doxysubsection{Automated Documentation}\label{md__r_e_a_d_m_e_autotoc_md19}
project uses Git\+Hub Actions to automate the generation of Doxygen documentation. Whenever changes are pushed to the {\ttfamily main} branch, the documentation is automatically updated and deployed to the {\ttfamily gh-\/pages} branch. This ensures that our documentation is always current and can be easily accessed through our Git\+Hub Pages site. 